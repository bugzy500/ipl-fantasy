...
const predictionSchema = new mongoose.Schema({
  ...
  predictionType: { type: String, enum: ['winner', 'superover'], default: 'winner' }, // winner: +50 pts, superover: +150 pts
  isCorrect: { type: Boolean, default: null }, // null = pending, true/false after match
  bonusPoints: { type: Number, default: 0 }, // +50 if correct (winner), +150 if correct (superover)
}, { timestamps: true });
